...
<body class="mainbody">
	<form name="form1" method="post" action="/Verwalter/fitment/price/header/list" id="form1">
		<div>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  			<tbody>
    			...
    			<#if headerPage??>
        			<#list headerPage.content as item>
			            <tr>
			                <td align="center">
			                ...
			                <td align="left">${item.priceType!''}</td>
			                <td align="left">
			                ...
			                <td align="center">
			                	<a href="/Verwalter/fitment/price/line/list/${item.id?c}">查看价目表项</a>
		                	</td>
			            </tr>
        			</#list>
    			</#if>
