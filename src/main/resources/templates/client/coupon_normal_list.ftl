...
<html>
    <head>
        ...
        <script src="/client/js/coupon_goods.js" type="text/javascript"></script>
        <script src="/client/js/seller_coupon.js" type="text/javascript"></script>
    </head>
    ...
    <body>
        ...
        <div>
            ...
            <div class="go_buy">
                <a style="background:#ffaa00;width:100%;" href="javascript:checkSeller();">立即购买</a>
