            ...
            <dl>
                ...
                <dd>
                    ...
                    <div>
                        ...
                        <input class="goodsSelectedQuantity" min="0" type="number" id="quantity${goods.id?c}" value="0" onchange="quantityChange(${goods.id?c})" onkeyup="keyup(this)" onafterpaste="afterpaste(this)" onfocus="clearQuantity(this)" 
