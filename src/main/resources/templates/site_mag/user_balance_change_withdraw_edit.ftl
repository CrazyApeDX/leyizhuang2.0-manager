...
<body class="mainbody">
<form name="form_user" method="post" action="/Verwalter/user/balance/change/withdraw/save" id="form">
<div>
...
<div class="location" style="position: static; top: 0px;">
  <a href="/Verwalter/user/balance/change/withdraw/list?roleId=${roleId!""}"><i></i><span>返回列表页</span></a>
...
<dl>
	<dt>可提现余额</dt>
	<dd><input name="cashBalance" id="cashBalance"  type="number" value="${amount?c}" class="input normal" readOnly="readOnly"></dd>
</dl>
<dl>
	<dt>不可提现余额</dt>
	<dd><input name="unCashBalance" id="unCashBalance" type="number" value="0.00" class="input normal" readOnly="readOnly"></dd>
</dl>
<dl>
    <dt>商户订单号</dt>
