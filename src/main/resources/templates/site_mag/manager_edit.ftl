...
<div class="tab-content" style="display: block;">
    ...
    <dl>
        ...
        <dd>
            ...
            <input  name="username" type="text" value="<#if tdManager??>${tdManager.username!""}</#if>" class="input normal" datatype="*6-100" sucmsg=" " ajaxurl="/Verwalter/manager/check<#if tdManager??>?id=${tdManager.id?c}</#if>">
