...
<form name="form1" method="post" action="/Verwalter/returnReason/list" id="form1">
<div>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar" style="position: static; top: 42px;">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="/Verwalter/returnReason/edit"><i></i><span>新增</span></a></li>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  ...
  <tr class="odd_bg">
    ...
    <#if reason_page??>
        <#list reason_page.content as item>
            <tr>
                <td align="center">
                ...
                <td align="center">
                    <a href="/Verwalter/returnReason/edit?id=${item.id?c}">修改</a>
                </td>
            </tr>
        </#list>
    </#if>
