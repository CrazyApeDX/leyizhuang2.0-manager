...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  ...
  <tr class="odd_bg">
    <th width="15%;">选择</th>
    <th width="35%" align="left" style="padding:8px 0;">&emsp;用户名</th>
    <th width="20%" align="left">用户角色</th>
    <th width="20%" align="left">归属门店</th>
    ...
    <#if user_page??>
        <#list user_page.content as user>
            <tr>
                ...
                <td align="center">
                    <a href="/Verwalter/user/balance/change/edit?id=${user.id?c}&roleId=${roleId!""}">变更</a>
              </tr>
        </#list>
    </#if>
