...
JpaSpecificationExecutor<FitCompanyReport>{
	...
	@Query(value="select UUID() id, a.* from"
	...
	List<FitCompanyReport> queryDownList(String begindata, String enddata, String city, String companyCode,
