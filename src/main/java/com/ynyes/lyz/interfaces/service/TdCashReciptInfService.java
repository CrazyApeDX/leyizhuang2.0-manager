...
public class TdCashReciptInfService {
	...
	public List<TdCashReciptInf> findBySendFlag(Integer flag) {
		if (null == flag) {
			return null;
		}
	...
	public TdCashReciptInf findByOrderNumberAndReceiptClassAndReceiptType(String orderNumber, String receiptClass,
			String receiptType) {
		if (null == orderNumber || null == receiptClass || null == receiptType) {
			return null;
		}
		return repository.findByOrderNumberAndReceiptClassAndReceiptType(orderNumber, receiptClass, receiptType);
	}
}
